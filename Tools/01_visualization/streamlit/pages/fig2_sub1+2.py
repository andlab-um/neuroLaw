...
df_long = df.melt(id_vars=['subject', 'group'], var_name='variable', 
...
plot = sns.catplot(kind="violin", x=x, hue=hue, y=y, split=True, dodge=True,
...
# plot.ax.set_ylim()
c = 'k'
box = sns.boxplot(data=df_long, x=x, y=y, hue=hue, color='white',
            order=order, hue_order=hue_order, 
            width=0.25, 
