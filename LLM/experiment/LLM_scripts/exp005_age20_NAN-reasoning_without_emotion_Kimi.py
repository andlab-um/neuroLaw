#!/usr/bin/env python3
"""
实验脚本 5: age:20 | NAN-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp005_age20_NAN-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 5: age:20 | NAN-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
