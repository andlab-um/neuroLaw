#!/usr/bin/env python3
"""
实验脚本 85: age:60 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp085_age60_short-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 85: age:60 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
