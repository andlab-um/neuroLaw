#!/usr/bin/env python3
"""
实验脚本 58: age:50 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp058_age50_NAN-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 58: age:50 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
