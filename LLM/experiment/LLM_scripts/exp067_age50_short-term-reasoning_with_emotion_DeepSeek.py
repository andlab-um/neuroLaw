#!/usr/bin/env python3
"""
实验脚本 67: age:50 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp067_age50_short-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 67: age:50 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
