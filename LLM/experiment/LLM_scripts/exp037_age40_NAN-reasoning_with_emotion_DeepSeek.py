#!/usr/bin/env python3
"""
实验脚本 37: age:40 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp037_age40_NAN-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 37: age:40 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
