#!/usr/bin/env python3
"""
实验脚本 43: age:40 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp043_age40_long-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 43: age:40 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
