#!/usr/bin/env python3
"""
实验脚本 79: age:60 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp079_age60_long-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 79: age:60 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
