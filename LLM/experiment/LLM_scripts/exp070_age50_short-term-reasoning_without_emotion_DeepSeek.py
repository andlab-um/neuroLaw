#!/usr/bin/env python3
"""
实验脚本 70: age:50 | short-term-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp070_age50_short-term-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 70: age:50 | short-term-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
