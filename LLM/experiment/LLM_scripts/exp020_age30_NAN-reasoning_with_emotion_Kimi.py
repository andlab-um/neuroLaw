#!/usr/bin/env python3
"""
实验脚本 20: age:30 | NAN-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp020_age30_NAN-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 20: age:30 | NAN-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
