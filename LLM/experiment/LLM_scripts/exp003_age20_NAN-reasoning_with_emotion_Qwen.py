#!/usr/bin/env python3
"""
实验脚本 3: age:20 | NAN-reasoning | with_emotion | Qwen3-235B-A22B-Instruct-2507
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp003_age20_NAN-reasoning_with_emotion_Qwen"
    ...
    print("=" * 80)
    print(f"实验 3: age:20 | NAN-reasoning | with_emotion | Qwen3-235B-A22B-Instruct-2507")
    print("=" * 80)
