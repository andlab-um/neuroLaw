#!/usr/bin/env python3
"""
实验脚本 13: age:20 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp013_age20_short-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 13: age:20 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
