#!/usr/bin/env python3
"""
实验脚本 25: age:30 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp025_age30_long-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 25: age:30 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
