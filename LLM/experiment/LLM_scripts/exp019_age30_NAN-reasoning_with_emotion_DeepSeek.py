#!/usr/bin/env python3
"""
实验脚本 19: age:30 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp019_age30_NAN-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 19: age:30 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
