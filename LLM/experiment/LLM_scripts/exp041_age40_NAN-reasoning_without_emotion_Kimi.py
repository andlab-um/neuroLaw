#!/usr/bin/env python3
"""
实验脚本 41: age:40 | NAN-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp041_age40_NAN-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 41: age:40 | NAN-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
