#!/usr/bin/env python3
"""
实验脚本 2: age:20 | NAN-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp002_age20_NAN-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 2: age:20 | NAN-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
