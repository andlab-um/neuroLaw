#!/usr/bin/env python3
"""
实验脚本 40: age:40 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp040_age40_NAN-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 40: age:40 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
