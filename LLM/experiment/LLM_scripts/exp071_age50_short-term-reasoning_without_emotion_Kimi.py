#!/usr/bin/env python3
"""
实验脚本 71: age:50 | short-term-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp071_age50_short-term-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 71: age:50 | short-term-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
