#!/usr/bin/env python3
"""
实验脚本 74: age:60 | NAN-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp074_age60_NAN-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 74: age:60 | NAN-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
