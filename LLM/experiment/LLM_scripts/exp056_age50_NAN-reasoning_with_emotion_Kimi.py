#!/usr/bin/env python3
"""
实验脚本 56: age:50 | NAN-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp056_age50_NAN-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 56: age:50 | NAN-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
