#!/usr/bin/env python3
"""
实验脚本 46: age:40 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp046_age40_long-term-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 46: age:40 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
