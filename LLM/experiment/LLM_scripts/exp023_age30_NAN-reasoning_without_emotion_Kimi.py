#!/usr/bin/env python3
"""
实验脚本 23: age:30 | NAN-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp023_age30_NAN-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 23: age:30 | NAN-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
