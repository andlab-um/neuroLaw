#!/usr/bin/env python3
"""
实验脚本 73: age:60 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp073_age60_NAN-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 73: age:60 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
