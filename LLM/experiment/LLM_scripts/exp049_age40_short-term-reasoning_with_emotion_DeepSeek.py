#!/usr/bin/env python3
"""
实验脚本 49: age:40 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp049_age40_short-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 49: age:40 | short-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
