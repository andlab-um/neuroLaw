#!/usr/bin/env python3
"""
实验脚本 10: age:20 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp010_age20_long-term-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 10: age:20 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
