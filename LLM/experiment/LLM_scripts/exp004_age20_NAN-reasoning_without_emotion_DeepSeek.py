#!/usr/bin/env python3
"""
实验脚本 4: age:20 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp004_age20_NAN-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 4: age:20 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
