#!/usr/bin/env python3
"""
实验脚本 68: age:50 | short-term-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp068_age50_short-term-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 68: age:50 | short-term-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
