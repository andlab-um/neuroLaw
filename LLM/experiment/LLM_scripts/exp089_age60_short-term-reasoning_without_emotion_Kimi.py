#!/usr/bin/env python3
"""
实验脚本 89: age:60 | short-term-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp089_age60_short-term-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 89: age:60 | short-term-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
