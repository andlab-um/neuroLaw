#!/usr/bin/env python3
"""
实验脚本 53: age:40 | short-term-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp053_age40_short-term-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 53: age:40 | short-term-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
