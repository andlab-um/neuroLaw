#!/usr/bin/env python3
"""
实验脚本 59: age:50 | NAN-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp059_age50_NAN-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 59: age:50 | NAN-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
