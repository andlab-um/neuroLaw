#!/usr/bin/env python3
"""
实验脚本 22: age:30 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp022_age30_NAN-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 22: age:30 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
