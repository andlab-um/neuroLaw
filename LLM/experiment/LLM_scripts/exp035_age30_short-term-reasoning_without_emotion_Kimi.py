#!/usr/bin/env python3
"""
实验脚本 35: age:30 | short-term-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp035_age30_short-term-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 35: age:30 | short-term-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
