#!/usr/bin/env python3
"""
实验脚本 55: age:50 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp055_age50_NAN-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 55: age:50 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
