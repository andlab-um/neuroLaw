#!/usr/bin/env python3
"""
实验脚本 1: age:20 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp001_age20_NAN-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 1: age:20 | NAN-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
