#!/usr/bin/env python3
"""
实验脚本 82: age:60 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp082_age60_long-term-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 82: age:60 | long-term-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
