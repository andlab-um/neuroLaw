#!/usr/bin/env python3
"""
实验脚本 61: age:50 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:50"
    experiment_prefix = "exp061_age50_long-term-reasoning_with_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 61: age:50 | long-term-reasoning | with_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
