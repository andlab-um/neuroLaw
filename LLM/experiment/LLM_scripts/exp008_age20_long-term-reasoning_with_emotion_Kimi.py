#!/usr/bin/env python3
"""
实验脚本 8: age:20 | long-term-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:20"
    experiment_prefix = "exp008_age20_long-term-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 8: age:20 | long-term-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
