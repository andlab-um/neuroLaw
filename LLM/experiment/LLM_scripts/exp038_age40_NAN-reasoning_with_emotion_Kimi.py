#!/usr/bin/env python3
"""
实验脚本 38: age:40 | NAN-reasoning | with_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:40"
    experiment_prefix = "exp038_age40_NAN-reasoning_with_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 38: age:40 | NAN-reasoning | with_emotion | Kimi-K2-0905")
    print("=" * 80)
