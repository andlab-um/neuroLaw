#!/usr/bin/env python3
"""
实验脚本 77: age:60 | NAN-reasoning | without_emotion | Kimi-K2-0905
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp077_age60_NAN-reasoning_without_emotion_Kimi"
    ...
    print("=" * 80)
    print(f"实验 77: age:60 | NAN-reasoning | without_emotion | Kimi-K2-0905")
    print("=" * 80)
