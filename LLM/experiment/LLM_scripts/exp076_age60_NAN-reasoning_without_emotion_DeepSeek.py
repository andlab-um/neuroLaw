#!/usr/bin/env python3
"""
实验脚本 76: age:60 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:60"
    experiment_prefix = "exp076_age60_NAN-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 76: age:60 | NAN-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
