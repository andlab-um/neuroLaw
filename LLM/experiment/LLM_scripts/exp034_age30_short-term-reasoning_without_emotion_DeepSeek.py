#!/usr/bin/env python3
"""
实验脚本 34: age:30 | short-term-reasoning | without_emotion | DeepSeek-V3-Fast
"""
...
if __name__ == "__main__":
    ...
    age = "age:30"
    experiment_prefix = "exp034_age30_short-term-reasoning_without_emotion_DeepSeek"
    ...
    print("=" * 80)
    print(f"实验 34: age:30 | short-term-reasoning | without_emotion | DeepSeek-V3-Fast")
    print("=" * 80)
